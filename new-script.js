(function () {
    ...
    var moreButton = "<button class='more-results'>Load more results</button>";
    ...
    function checkScrollPostion() {
        ...
        var trackLength = documentHeight - windowsHeight;
        var scrollTop = $(window).scrollTop();
        percentScrolled = Math.floor(scrollTop / trackLength * 100) // gets percentage scrolled (ie: 80 NaN if tracklength == 0)
        // if(percentScrolled >90) {
            // console.log("result of checkScrollPosition", percentScrolled);
            return percentScrolled;
        }
        
   $(window).on("scroll", function(){
    amountScrolled = checkScrollPostion();

    console.log("percentScrolled", amountScrolled, data.next);
    // return percentScrolled;
